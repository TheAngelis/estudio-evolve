...
$(document).ready(function () {
    ...
    function initColorBox() {
        //How to assign the Colorbox event to elements
				$(".cb-img").colorbox({rel:'cb-img', transition:"fade"});
				$(".ajax").colorbox();
    ...
    var submit2 = $('#contactForm_submit2');
    var alertx2 = $('.form-respond2');
    // form submit event
    $(document).on('submit', '#contactform2', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                form2.fadeOut(300);
                alertx2.html(data).fadeIn(1000); // fade in response data
                setTimeout(function () {
                    alertx2.html(data).fadeOut(300);
                    $('#name, #email,#phone, #message').val('');
                    form2.fadeIn(1800);
                }, 4000);
            },
